...
%	   eddie 04.29.08 added 10 generic variables (short integers) named VARS that can be used to store things
%	   jenni 05.22.08 making a non-struct version

function [p] = jg_read_preamble5(fid,VSG_FLAG,USR_PREAMB_ELEMENTS);
