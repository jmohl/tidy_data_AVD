% G_READ_PREAMBLE            Read in Gramalkn 3.0 data preamble
% 
%     [p] = g_read_preamble(fid,VSG_FLAG,USR_PREAMB_ELEMENTS);
%
...
function [p] = g_read_preamble(fid,VSG_FLAG,USR_PREAMB_ELEMENTS);
