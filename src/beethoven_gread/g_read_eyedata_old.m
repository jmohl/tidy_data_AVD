...
function [eyedata,statedata] = g_read_eyedata(fid,nsamples,neyes,eyegain,dt,datatype_version);
...
for i = 1:neyes
	eyedata(:,2*(i-1)+1) = xpos(i:neyes:end)/eyegain;
	eyedata(:,2*(i-1)+2) = ypos(i:neyes:end)/eyegain;
end
